...
- Setup database objects/models (Im assuming most will also go under user objects) -- still need to do Doctor, SysAdmin, Test, TestResult, Laboratory, Calendar, Appointment, Reminder, Message, Fee, and BillFee
